...
| Cloud Run service | `driftline` in `us-central1` | Ready, latest revision `driftline-00101-vcd` from commit `5843a37` | Public URL: https://driftline-xvxczqg62a-uc.a.run.app/; min 0, service and revision max 1, 1 CPU, 512 MiB, concurrency 20, tenant-bound reads/writes/action-lifecycle/quotas require signed identity; connector credentials are tenant-bound through isolated Secret Manager bindings |
...
| Artifact Registry | `driftline` Docker repo in `us-central1` | Active | Latest verified image: `us-central1-docker.pkg.dev/driftline-hackathon-2026/driftline/driftline@sha256:bad0193ce6f969fa6c45b55e4fb31e28a71e87459c54ddedbd5ecce97e49cbfa` |
