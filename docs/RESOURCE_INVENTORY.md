...
| Cloud Run service | `driftline` in `us-central1` | Ready, revision `driftline-00024-dbp`, 100% traffic | Public URL: https://driftline-xvxczqg62a-uc.a.run.app/; min 0, service max 1, 1 CPU, 512 MiB, concurrency 20, timeout 300s |
...
| Artifact Registry | `driftline` Docker repo in `us-central1` | Active | Serving image: `us-central1-docker.pkg.dev/driftline-hackathon-2026/driftline/driftline:7c869b85-ae12-42cc-b657-3f6e06ec8a0d`; digest `sha256:6e98e0c10a4359def802b0fe0542173e1dd6364de83feb4c427443daa3a6c570` |
...
Cloud Build ID `7c869b85-ae12-42cc-b657-3f6e06ec8a0d` completed successfully
in `global` and deployed revision `driftline-00024-dbp`. The exact image
digest serving Cloud Run is
`sha256:6e98e0c10a4359def802b0fe0542173e1dd6364de83feb4c427443daa3a6c570`.
...
The current public release was exercised on revision `driftline-00024-dbp`:
...
- The live competitor run on the current revision used job
  `job-42a13a7a7259`, workflow `cdc37d08-5c90-4586-8548-77bcebeef06c`, and
  ...
  the structured analysis reported four artifacts.
