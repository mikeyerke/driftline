...
| Cloud Run service | `driftline` in `us-central1` | Ready, latest revision `driftline-00100-n6v` from commit `fde1e31` | Public URL: https://driftline-xvxczqg62a-uc.a.run.app/; min 0, service and revision max 1, 1 CPU, 512 MiB, concurrency 20, tenant-bound reads/writes/quotas require signed identity; connector credentials are tenant-bound through isolated Secret Manager bindings |
...
| Artifact Registry | `driftline` Docker repo in `us-central1` | Active | Latest verified image: `us-central1-docker.pkg.dev/driftline-hackathon-2026/driftline/driftline@sha256:07c25dc11f8e504d33845c9717cfeefa6750810199426b5a9a7d8744bad11267` |
