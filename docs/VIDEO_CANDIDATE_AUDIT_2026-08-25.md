...
runs completed with 152 and 150 captured state-change frames. Both asserted:
...
The retained run is 16.47 seconds, H.264, 1280 × 720, 30 fps, standard-range
YUV420p, with no black-frame detection. It is materially stronger continuity
evidence than the static fallback, but it is silent and cursor-free. It is a
repeatable candidate QA insert, not the final narrated public demo and not
production proof.
