...
Current release: source `c136b0b99e5a505a26b92a5e549fe55cf32f72a3`, Cloud Run
`driftline-00160-bp4`, Cloud Build
`198261e2-b8af-4e01-8439-56d0c11f27cb`, project
...
- Logged-out desktop and 390x844 mobile browser QA showed the interactive
  ...
  the viewport width.
- `scripts/verify_live_agent.sh`: fresh job `job-1cbbe78e530f`, workflow
  `ea9953e8-ddb8-46db-be7d-601f7609d77c`, five audit events, four artifacts,
  two decision options, and `needs_approval`.
- `scripts/verify_public_approval_undo.sh`: fresh job `job-951c0dea75a9`,
  workflow `6f29da58-dcad-49f9-9385-d2ce54779783`; the packet persisted and
...
- A post-deploy direct Scheduler run at `2026-08-22T01:51:40Z` returned an
  OIDC-authenticated HTTP 200 on `driftline-00160-bp4`; the registry then
...
- 265 backend tests, Ruff, frontend production build, standalone image build,
  and repository hygiene pass in GitHub Actions run `32544337366`; the frozen
