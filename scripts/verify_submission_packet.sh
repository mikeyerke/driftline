...
require_text scripts/summarize_real_pm_pilot.py 'Product-observed intake-to-reviewed-brief:'
...
require_text submission/REAL_PM_PILOT.md 'It is not baseline time'
...
require_text submission/PILOT_PROSPECT_PIPELINE.md '**2 sent, 0 replies, 0 qualified decisions,'
require_text submission/PILOT_PROSPECT_PIPELINE.md 'Do not send a'
require_text submission/PILOT_OUTREACH_DRAFTS.md 'Every other message below remains an unsent draft.'
