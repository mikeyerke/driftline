...
try {
  for (const [name, width, height] of [
    ...
    results[name] = {
      ...
      freshContextRestored: restoredLower.includes("workflow completion rate") && restoredLower.includes("measurement opens") && restoredLower.includes("bounded internal action executed"),
