...
- The current active release is source commit `2f7865d`, Cloud Build
  `c1ffee0f-3ebd-44b3-8ec1-8b2e82979c32`, and Cloud Run revision
  `driftline-00095-nph` at 100% traffic. It passed 241 backend tests, Ruff,
