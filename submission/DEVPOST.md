...
- The current active release is source commit `510be63`, Cloud Build
  `49245582-02c4-4cf8-b9a3-97763eaf1a2a`, and Cloud Run revision
  `driftline-00096-shm` at 100% traffic. It passed 241 backend tests, Ruff,
