...
- The current active release is source commit `3d3d2d7`, Cloud Build
  `557f98b9-dfb0-4586-abca-4a44ac9b6877`, and Cloud Run revision
  `driftline-00076-7qw` at 100% traffic. It passed 237 backend tests, Ruff,
